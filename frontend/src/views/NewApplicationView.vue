...
const formattedCurrentDateTime: string = format(
  new Date(),
      ...
      >
        <form @submit.prevent="handleSubmit">
          ...
          <div>
            ...
            <RouterLink
              to="/"
              class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline block text-center block"
            >
              Cancel
            </RouterLink>
          </div>
